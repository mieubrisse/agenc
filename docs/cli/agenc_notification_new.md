...
```
  ...
  -h, --help                 help for new
      ...
      --mission-id string    link this notification to a mission (UUID or short ID); defaults to $AGENC_MISSION_UUID when set; ENTER on the notification in 'manage' attaches to it
